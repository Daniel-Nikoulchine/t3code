...
describe("home project scopes", () => {
  ...
  it("matches web repository, repository-path, and separate grouping modes", () => {
    ...
    const scopeTitles = (projectGroupingMode: "repository" | "repository_path" | "separate") =>
    ...
    expect(scopeTitles("repository_path")).toEqual(["Mobile", "Web"]);
    expect(scopeTitles("separate")).toEqual(["Mobile", "Web"]);
  });
});
