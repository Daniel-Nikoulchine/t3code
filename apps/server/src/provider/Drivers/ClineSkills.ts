...
interface ClineSkillScanBudget {
...
function parseSkillFrontmatter(contents: string): ClineSkillFrontmatter | undefined {
...
const discoverSkillsInRoot = Effect.fn("discoverClineSkillsInRoot")(function* (input: {
  readonly directory: string;
  readonly scope: "user" | "project";
  readonly budget: ClineSkillScanBudget;
  ...
  const visit = Effect.fn("visitClineSkillDirectory")(function* (
    directory: string,
    depth: number,
    ...
    if (skillInfo?.type === "File") {
      let frontmatter: ClineSkillFrontmatter | undefined = { cliVisible: true };
...
const inspectClineSkills = Effect.fn("inspectClineSkills")(function* (
  ...
  const budget: ClineSkillScanBudget = {
