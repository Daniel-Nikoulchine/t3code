...
/**
 * Per-instance environment-variable editor with its own draft/publish
 * cycle: rows edit locally and publish only valid states (invalid names
 * block the publish instead of corrupting settings).
 */
